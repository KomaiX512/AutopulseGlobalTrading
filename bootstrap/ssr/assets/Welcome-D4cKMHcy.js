...
import { a as HomeContext, H as HomeContextProvider } from "./AttachmentComponent-CRE5apCQ.js";
import { useParams, BrowserRouter, Routes, Route } from "react-router-dom";
import { S as SolutionsByProject, P as ProductComponent, H as HomePage, O as OrderSuccess } from "./OrderSuccess-D7h7KWwO.js";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "product-page-container", children: [
    (attachment == null ? void 0 : attachment.category) && /* @__PURE__ */ jsx("div", { className: "hero-section", children: /* @__PURE__ */ jsxs("div", { className: "hero-image-container", children: [
      /* @__PURE__ */ jsx(
        "img",
        {
          src: `${((_b = (_a = attachment == null ? void 0 : attachment.category) == null ? void 0 : _a.image) == null ? void 0 : _b.replace("public", "/storage")) || "/storage/images/default-category.jpg"}`,
          alt: `${(_c = attachment == null ? void 0 : attachment.category) == null ? void 0 : _c.name} Category`,
          className: "hero-image"
        }
      ),
      /* @__PURE__ */ jsx("div", { className: "hero-overlay", children: /* @__PURE__ */ jsx("h1", { className: "hero-title", children: (_d = attachment == null ? void 0 : attachment.category) == null ? void 0 : _d.name }) })
    ] }) }),
...
function SolutionProducts() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-r from-blue-600 to-purple-700 text-white py-16", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: "bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-300",
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              className: "bg-gray-500 hover:bg-gray-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-300",
      ...
      Empty,
      {
        ...
        children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
          ...
          /* @__PURE__ */ jsx(
            ...
            {
              onClick: () => window.location.href = "/products/machine",
              className: "bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-lg transition-colors duration-300",
              children: "Browse All Machines"
            }
          )
        ] })
        ...
        return /* @__PURE__ */ jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-blue-500 font-medium text-sm hover:text-blue-600", children: "Learn more →" })
            ]
          },
          relatedSolution.id
        );
