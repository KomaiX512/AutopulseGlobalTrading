...
import { H as HomeContextProvider, a as HomeContext } from "./AttachmentComponent-BnWqiux2.js";
...
const AttachmentProductContent = ({ auth }) => {
  ...
  async function fetchReviews() {
    var _a2;
    if ((_a2 = state == null ? void 0 : state.selectedAttachment) == null ? void 0 : _a2.id) {
