  ...
  return /* @__PURE__ */ jsx("div", { className: "product-card group", style: { height: "100%" }, "data-wow-delay": `0.${index + 2}s`, children: /* @__PURE__ */ jsxs("div", { className: "product-item relative w-full flex flex-col bg-white border border-gray-200 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 overflow-hidden", style: { height: "100%", minHeight: "400px" }, children: [
      ...
      /* @__PURE__ */ jsxs(Image.PreviewGroup, { children: [
        /* @__PURE__ */ jsx(
          Image,
          {
            ...
            src: `${((_a = attachment == null ? void 0 : attachment.primary_image) == null ? void 0 : _a.path) ? attachment.primary_image.path.replace("public", "/storage") : "/images/placeholder-attachment.jpg"}`,
            fallback: "/images/placeholder-attachment.jpg",
            alt: (attachment == null ? void 0 : attachment.name) || `Attachment ${index + 1}`
          }
        ),
        (_b = attachment == null ? void 0 : attachment.images) == null ? void 0 : _b.map((image, idx) => {
          var _a2;
          return /* @__PURE__ */ jsx(
            Image,
            {
              loading: "lazy",
              src: `${(_a2 = image == null ? void 0 : image.path) == null ? void 0 : _a2.replace("public", "/storage")}`,
    ...
    /* @__PURE__ */ jsxs("div", { className: "product-details p-4 flex-1 flex flex-col justify-between", style: { minHeight: "120px" }, children: [
      /* @__PURE__ */ jsxs("div", { className: "down-content flex-1", children: [
        isBusiness && /* @__PURE__ */ jsxs("div", { className: "flex text-cats flex-wrap align-center gap-3 pb-3 py-2", style: { lineHeight: "normal", fontSize: "14px" }, children: [
          /* @__PURE__ */ jsxs("div", { className: "flex align-center gap-2", children: [
            /* @__PURE__ */ jsx(GrCalendar, { color: "#6B7280", size: 18 }),
            /* @__PURE__ */ jsx("span", { className: "text-dark", style: { fontSize: "14px", fontWeight: "500" }, children: (attachment == null ? void 0 : attachment.year) || "Latest" })
          ] }),
          ((_c = attachment == null ? void 0 : attachment.category) == null ? void 0 : _c.product_type_id) != 2 && /* @__PURE__ */ jsxs("div", { className: "flex align-center gap-2", children: [
            /* @__PURE__ */ jsx(GrCalendar, { color: "#6B7280", size: 18 }),
            /* @__PURE__ */ jsx("span", { className: "text-dark", style: { fontSize: "14px", fontWeight: "500" }, children: attachment == null ? void 0 : attachment.make })
          ] }),
          ((_d = attachment == null ? void 0 : attachment.category) == null ? void 0 : _d.product_type_id) !== 2 && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "flex align-center gap-2", children: [
            /* @__PURE__ */ jsx(GrCar, { color: "#6B7280", size: 18 }),
            /* @__PURE__ */ jsx("span", { className: "text-dark", style: { fontSize: "14px", fontWeight: "500" }, children: (_e = attachment == null ? void 0 : attachment.category) == null ? void 0 : _e.name })
          ] }) }),
          ((_f = attachment == null ? void 0 : attachment.category) == null ? void 0 : _f.product_type_id) === 1 && /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "flex align-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxs("span", { className: "text-dark", style: { fontSize: "14px", fontWeight: "500" }, children: [
              attachment == null ? void 0 : attachment.weight,
              " Tons"
            ] })
          ] }) })
        ] }),
        /* @__PURE__ */ jsx("a", { title: "View Attachment Details", className: "card-title-link", style: { height: "50px", display: "block" }, href: `/attachment/${attachment == null ? void 0 : attachment.slug}`, children: /* @__PURE__ */ jsx(Tooltip, { title: attachment == null ? void 0 : attachment.name, children: /* @__PURE__ */ jsx("h4", { className: "text-xl font-bold text-gray-800 text-center group-hover:text-gray-600 transition-colors duration-300 m-0", style: { lineHeight: "1.3", fontSize: "18px" }, children: attachment == null ? void 0 : attachment.name }) }) }),
        !isBusiness && /* @__PURE__ */ jsx("small", { children: /* @__PURE__ */ jsxs("div", { style: { color: "gray", fontSize: "14px", fontWeight: "500" }, className: "mb-2 text-zinc-400", children: [
          "Stock: ",
